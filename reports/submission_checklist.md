...
The submitted system uses local CSV storage plus GitHub Actions artifacts. A production feature store/model registry such as Hopsworks is listed as future work and is not claimed as implemented. The explanation output uses Random Forest feature importance locally, with optional SHAP support in the explanation script.
...
5. Open the Actions tab and show successful hourly/daily runs.
6. Show model metrics and explain why different horizons select different models.
